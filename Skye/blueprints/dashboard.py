...
Handles stock market data, currency rates, portfolio tracking, and sell recommendations
"""
...
def get_currency_data():
    ...
    try:
        ...
        period = request.args.get('period', '1y')
        current_app.logger.info(f"Currency data (USD/EUR) requested, period: {period}")
